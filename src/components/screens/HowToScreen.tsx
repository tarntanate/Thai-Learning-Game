  ...
  return (
    <div className="mx-auto flex w-full max-w-2xl flex-col gap-4">
      ...
      <GlassCard delay={0.2}>
        ...
        <ul className="space-y-2 text-sm text-slate-600">
          <li>
            • ตอบถูกทุกข้อ → ได้คุณครูช่วยเฉลย 1 ชิ้นแน่นอน + สุ่ม 2 ชิ้น
            (คุณครูช่วยเฉลย / แมวเปลี่ยนคำถาม / คฑาพ่อมด)
          </li>
          <li>• พลาดไม่เกิน 2 ข้อ → ได้ไอเท็มสุ่ม 2 ชิ้น</li>
          <li>• พลาดตั้งแต่ 3 ข้อขึ้นไป → ได้นาฬิกาเวลา 1 ชิ้น</li>
          <li>
            • เลื่อนเลเวล (Level Up) → ได้รับคุณครูช่วยเฉลยเพิ่มพิเศษ 1 ชิ้น
          </li>
